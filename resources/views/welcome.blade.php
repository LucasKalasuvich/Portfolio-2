...
<body>
  ...
  <header id="header">
    <div class="d-flex flex-column">
      ...
      <div class="profile">
        <img src="assets/img/lucas.jpg" alt="" class="img-fluid rounded-circle">
      ...
      <nav id="navbar" class="nav-menu navbar">
        <ul>
          ...
          <li><a href="{{asset('storage/CV-Lucas Kalasuvich.pdf')}}" class="nav-link scrollto" download><i class="bx bx-download"></i> <span>Curriculum Vitae</span></a></li>
        </ul>
      </nav><!-- .nav-menu -->
    </div>
  </header><!-- End Header -->
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <ul>
                  ...
                  <li><i class="bi bi-chevron-right"></i> <strong>Degree:</strong> <span>Sarjana</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Email:</strong> <span>lucas080701@gmail.com</span></li>
                  {{-- <li><i class="bi bi-chevron-right"></i> <strong>Freelance:</strong> <span>Available</span></li> --}}
                </ul>
              </div>
            </div>
            <p>Saya berumur 21 tahun, lulusan sarjana (S1). Saya pernah melakukan internship di instansi Dewan Perwakilan 
                Rakyat Republik (DPR RI) Indonesia Selama 1 tahun pengalaman. Memiliki kemampuan di bidang web developer sebagai backend developer menggunakan framework laravel.</p>
          </div>
        </div>
        ...
        <div class="section-title">
          ...
          <div class="col-lg-6" data-aos="fade-left">
            <ul>
              ...
              <li><i class="bi"></i> <span>Drawing</span></li>
            </ul>
          </div>
        </div>
      </div>
